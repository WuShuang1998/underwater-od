...
def parse_args():
    ...
    parser.add_argument('--json_out', default='results.json', type=str, help='name of output result file')
    parser.add_argument(
        '--format_only',
        action='store_true',
...
def main():
    ...
    if rank == 0:
        ...
        if args.format_only:
            dataset.format_results(outputs, json_out=args.json_out, **kwargs)
        if args.eval:
