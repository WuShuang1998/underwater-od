...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(3840, 1800), (3840, 800)],
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(3840, 1300), #[(4096, 600), (4096, 800), (4096, 1000)],
        flip=False,
        transforms=[
...
log_level = 'INFO'
work_dir = './work_dirs/cas_x101_64x4d_fpn_htc_1x_ms800_1800'
load_from = './weights/htc_dconv_c3-c5_mstrain_400_1400_x101_64x4d_fpn_converted2.pth'
resume_from = None
workflow = [('train', 1)]