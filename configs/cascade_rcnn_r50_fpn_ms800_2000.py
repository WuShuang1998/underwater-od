...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(3840, 1400),  #[(3840, 1200), (3840, 1000), (3840, 800)],
        flip=True,
        transforms=[
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_r50_fpn_ms800_2000'
load_from = './weights/cascade_rcnn_r50_fpn_20e_converted.pth' #'./weights/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth'
resume_from = None
workflow = [('train', 1)]
