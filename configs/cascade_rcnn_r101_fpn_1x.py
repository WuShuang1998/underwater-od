...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(3840, 1200), (3840, 800)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(3840, 1000),  #[(3840, 1200), (3840, 1000), (3840, 800)]
        flip=False,
        transforms=[
...
load_from = './weights/cascade_rcnn_r101_fpn_20e_converted.pth' #'./weights/cascade_rcnn_r50_fpn_20e_20181123-db483a09.pth'
resume_from = None
workflow = [('train', 1)]
