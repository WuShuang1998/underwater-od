...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(3840, 800), (3840, 2000)], 
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(3840, 800), (3840, 1000), (3840, 1200), (3840, 1400), (3840, 1600), (3840, 1800), (3840, 2000)],  # [(3840, 800), (3840, 1000), (3840, 1200), (3840, 1400), (3840, 1600), (3840, 1800), (3840, 2000)],
        flip=True,
        transforms=[
...
load_from = './weights/cascade_rcnn_dconv_c3-c5_r101_fpn_1x_converted.pth'  
resume_from = None
workflow = [('train', 1)]
