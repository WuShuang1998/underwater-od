...
class CocoDataset(CustomDataset):
    ...
    def results2json(self, results, outfile_prefix, out_file='results.json'):
        ...
        json.dump(json_results, open(out_file, 'w'), indent=4)
        return result_files
    ...
    def format_results(self, results, jsonfile_prefix=None, json_out='results.json', **kwargs):
        ...
        if jsonfile_prefix is None:
            ...
            tmp_dir = None
        result_files = self.results2json(results, jsonfile_prefix, json_out)
